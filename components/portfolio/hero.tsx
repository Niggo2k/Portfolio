          ...
          <div className="content-stretch flex flex-col items-start px-16 pt-8 pb-8 max-md:px-8 max-md:pt-8 max-md:pb-4 relative w-full">
            <div className="content-stretch flex items-start justify-between relative shrink-0 w-full">
              <div className="relative shrink-0 size-11">
                <img alt="Michelle Liu Logo" className="object-contain pointer-events-none size-full" src="/assets/logo-CcKS_K74.png" />
              </div>
            </div>
          </div>
        </div>
      </div> */}
      <div className="relative shrink-0 w-full z-2 mt-28">
        <div className="size-full">
              ...
              <div className="flex flex-col gap-0 font-normal tracking-wide leading-6 max-md:leading-5.5 text-[#6b7280] dark:text-[#9ca3af] text-lg max-md:text-base w-full max-md:max-w-86 whitespace-pre-wrap mt-3 max-md:mt-3">
                ...
                <div className="flex gap-0">
                  ...
                  <span className="relative inline-flex items-center justify-center rounded-[999px] transition-all ease-in-out w-fit bg-[#ecfdf5] dark:bg-emerald-950/50 align-middle -translate-y-[2px] [cursor:inherit] before:content-[''] before:absolute before:-inset-[2px] before:rounded-[999px] before:pointer-events-none md:gap-0 pl-1 pr-2.5 md:pr-0 ml-1 md:ml-2 duration-300">
                    ...
                    <span className="font-['Figtree:Medium',sans-serif] font-normal text-emerald-600 text-sm md:text-base tracking-[0.005em] text-nowrap overflow-hidden transition-all ease-out duration-300 max-md:max-w-[200px] max-md:opacity-100 md:max-w-0 md:opacity-0">
