...
export default function AboutPage() {
  ...
  return (
    <main className="bg-background content-stretch flex flex-col items-center relative size-full min-h-screen">
      ...
      <Hero
        name={profile.name}
        tagline={"Curious. Creative. Committed."}
      />
        ...
        <div className="size-full">
          <div className="content-stretch flex flex-col gap-3 items-start pb-0 pt-4 px-16 max-md:px-8 relative w-full">
            <div className="content-stretch flex gap-1 items-start relative shrink-0">
              <Link
                href="/"
                className="content-stretch flex items-center justify-center px-3.5 pt-[5px] pb-[4px] relative rounded-full shrink-0 cursor-pointer transition-all duration-100 ease-out border border-transparent hover:bg-muted/40 hover:pt-[3px] hover:pb-[2px] hover:my-[2px]"
              >
                <p className=" font-medium leading-normal tracking-[0.005em] relative shrink-0 text-[1.07em] text-nowrap text-muted-foreground">
                  Work
                </p>
              </Link>
              <span className="content-stretch flex items-center justify-center px-3.5 pt-[5px] pb-[4px] relative rounded-full shrink-0 cursor-pointer transition-all duration-100 ease-out border border-transparent bg-muted/60 backdrop-blur-md shadow-[0_2px_8px_rgba(0,0,0,0.06),inset_0_1px_1px_rgba(255,255,255,0.9),inset_0_-1px_1px_rgba(0,0,0,0.02)] dark:shadow-[0_2px_8px_rgba(0,0,0,0.2)] border-border/50">
                <p className=" font-medium leading-normal tracking-[0.005em] relative shrink-0 text-[1.07em] text-nowrap text-foreground">
                  About
                </p>
              </span>
            </div>
